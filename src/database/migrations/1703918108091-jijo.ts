...
export class Jijo1703918108091 implements MigrationInterface {
    name = 'Jijo1703918108091'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."prestamo_frecuencia_enum" AS ENUM('semanal', 'diario', 'mensual', 'quincenal')`);
        await queryRunner.query(`CREATE TYPE "public"."prestamo_estado_enum" AS ENUM('activo', 'vencido', 'mensual')`);
        await queryRunner.query(`CREATE TABLE "prestamo" ("id" SERIAL NOT NULL, "capital" numeric(10,2) NOT NULL DEFAULT '0', "porcentaje" numeric(10,2) NOT NULL DEFAULT '0', "intereses" numeric(10,2) NOT NULL DEFAULT '0', "mora" numeric(10,2) NOT NULL DEFAULT '0', "frecuencia" "public"."prestamo_frecuencia_enum" NOT NULL DEFAULT 'semanal', "estado" "public"."prestamo_estado_enum" NOT NULL DEFAULT 'activo', "inicio" date NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "vencimiento" date NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "clienteId" integer, CONSTRAINT "PK_f278f946a735410406b7d965b2a" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."prestamo_estado_enum"`);
        await queryRunner.query(`DROP TYPE "public"."prestamo_frecuencia_enum"`);
    }
