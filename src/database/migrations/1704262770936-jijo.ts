...
export class Jijo1704262770936 implements MigrationInterface {
    name = 'Jijo1704262770936'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "prestamo" ("id" SERIAL NOT NULL, "inicio" date NOT NULL, "vencimiento" date NOT NULL, "capital" numeric(10,2) NOT NULL DEFAULT '0', "porcentaje" numeric(10,2) NOT NULL DEFAULT '0', "mora" numeric(10,2) NOT NULL DEFAULT '0', "estado" character varying(255) NOT NULL DEFAULT 'activo', "frecuencia" character varying(255) NOT NULL DEFAULT 'diario', "proxima" date NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "updated_at" TIMESTAMP NOT NULL DEFAULT ('now'::text)::timestamp(6) with time zone, "clienteId" integer, CONSTRAINT "PK_f278f946a735410406b7d965b2a" PRIMARY KEY ("id"))`);
